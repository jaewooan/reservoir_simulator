function [iFigure] = plotCompareComp(iFigure, outputRef, output, fluidRef, fluid, wellRef, well, grid, fn)
...
hold on
lgd = legend('Incompressibility', 'Compressibility', 'Eclipse');
lgd.FontSize = 14;
...
ss = suptitle('Water saturation with compressibility');
...
ss = suptitle('Water saturation with incompressibility');
set(ss,'FontSize',20,'FontWeight','normal')
iFigure=iFigure+1;
...
ss = suptitle('Oil pressure with compressibility');
set(ss,'FontSize',20,'FontWeight','normal')
iFigure=iFigure+1;
...
ss = suptitle('Oil pressure with incompressibility');
set(ss,'FontSize',20,'FontWeight','normal')
iFigure=iFigure+1;
...
lgd = legend('Incompressibility', 'Compressibility');
lgd.FontSize = 14;
xlabel('Time(year)','FontSize',14)
